...
const TextStyle labelTextMidBlack =
    TextStyle(fontFamily: 'nunito', fontSize: 16, color: backgroundColor);

const TextStyle descriptionText =
    TextStyle(fontFamily: 'nunito', fontSize: 14, color: backgroundColor);
...
const TextStyle labelButtonText =
    TextStyle(fontFamily: 'nunito', fontSize: 18, color: Colors.white);
